...
public class SequenceFileSerializerFactory {
  ...
  static com.stratio.ingestion.sink.hdfs.SequenceFileSerializer getSerializer(String formatType,
                                              Context context) {
    ...
    if (builderClass == null) {
      try {
        ...
        if (c != null && com.stratio.ingestion.sink.hdfs.SequenceFileSerializer.Builder.class.isAssignableFrom(c)) {
          builderClass = (Class<? extends com.stratio.ingestion.sink.hdfs.SequenceFileSerializer.Builder>) c;
        } else {
        ...
        logger.error("Class does not extend " +
            com.stratio.ingestion.sink.hdfs.SequenceFileSerializer.Builder.class.getCanonicalName() + ": " +
            formatType, ex);
        return null;
      }
    }
    ...
    // build the builder
    com.stratio.ingestion.sink.hdfs.SequenceFileSerializer.Builder builder;
    try {
